...
const defaultEmails: EmailRecord[] = [
  {
    ...
    emailSubject: 'Relance — Patrimoine Amazigh Vivant – Grenier Collectif ANATDC',
    dateSent: '2026-06-29',
    status: 'relance',
    nextActionDate: '2026-07-11',
    notes: 'Email de relance J+4 envoyé le 29 juin 2026. En attente de réponse. Prochaine relance prévue 11 juillet.',
  },
  {
    id: 'email-bmce',
    funder: 'BMCE Foundation',
    ...
    dateSent: '2026-06-27',
    status: 'refusé',
    notes: 'Email invalide - abandonné. L\'adresse fondation@bmce.ma n\'existe pas ou n\'est pas disponible.',
  },
  {
    id: 'email-pnud',
    funder: 'PNUD Maroc',
    email: 'registry.ma@undp.org',
    emailSubject: 'Relance — Patrimoine Collectif et Développement Durable – ANATDC',
    dateSent: '2026-06-29',
    status: 'relance',
    nextActionDate: '2026-07-11',
    notes: 'Email de relance J+4 envoyé le 29 juin 2026. En attente de réponse. Prochaine relance prévue 11 juillet.',
  },
  {
    ...
    emailSubject: 'Relance — Preservation du Patrimoine & Développement Communautaire – ANATDC',
    dateSent: '2026-06-29',
    status: 'relance',
    nextActionDate: '2026-07-11',
    notes: 'Email de relance J+4 envoyé le 29 juin 2026. En attente de réponse. Prochaine relance prévue 11 juillet.',
  ...
  },
  {
    ...
    emailSubject: 'Relance — Patrimoine Immatériel Amazigh – Grenier Collectif ANATDC',
    dateSent: '2026-06-29',
    status: 'relance',
    nextActionDate: '2026-07-11',
    notes: 'Email de relance J+4 envoyé le 29 juin 2026. En attente de réponse. Prochaine relance prévue 11 juillet.',
